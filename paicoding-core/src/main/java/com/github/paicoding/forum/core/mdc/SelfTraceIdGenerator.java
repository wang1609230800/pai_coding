...
public class SelfTraceIdGenerator {
    ...
    private static final AtomicInteger autoIncreaseNumber = new AtomicInteger(MIN_AUTO_NUMBER);
    ...
    private static int getAutoIncreaseNumber() {
        return autoIncreaseNumber.updateAndGet(current -> current >= MAX_AUTO_NUMBER ? MIN_AUTO_NUMBER : current + 1);
    }
